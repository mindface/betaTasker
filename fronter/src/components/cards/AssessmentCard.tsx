...
export default function AssessmentCard({ assessment, onRefresh }: AssessmentCardProps) {
    ...
    <div className="assessment-details">
      ...
      <div className="scores-grid">
        <div className="score-item">
          ...
          <span className="score-value">{assessment.effectiveness_score}/100</span>
  ...
  const renderEditForm = (assessment: Assessment, onChange: (assessment: Assessment) => void) => (
    <form className="assessment-edit-form">
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) => onChange({ ...assessment, task_id: Number(e.target.value) })}
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) => onChange({ ...assessment, effectiveness_score: Number(e.target.value) })}
          min={0}
          max={100}
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) => onChange({ ...assessment, effort_score: Number(e.target.value) })}
          min={0}
          max={100}
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) => onChange({ ...assessment, impact_score: Number(e.target.value) })}
          min={0}
          max={100}
        />
      </div>
      <div className="form-group">
        ...
        <textarea
          ...
          onChange={(e) => onChange({ ...assessment, qualitative_feedback: e.target.value })}
          rows={3}
        />
      </div>
    </form>
  ...
  const getDescription = (assessment: Assessment) => {
    return assessment.qualitative_feedback || 
