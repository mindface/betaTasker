...
export default function ItemCardSearchLink(props: Props) {
  ...
  return (
    <div className="search-link-box">
        ...
        {LinkData.map((item) => {
          ...
          return (
            <div
              ...
              key={item.id}
              onClick={(e: React.MouseEvent) => urlCopy(e, item.id, item.link)}
            >
      ...
      <ul className="list">
        <li className="item">
          <label htmlFor="select-title" className="label">
            調査文字列
          </label>
          <input
            type="text"
        ...
        <li className="item">
          <label htmlFor="target-site" className="label">
            特定のサイトを確認する[googleのみ]
          </label>
          <input
            type="text"
            className="input"
        ...
        <li className="item">
          <label htmlFor="url-text" className="label">
            検索URL
          </label>
          <input
            type="text"
      ...
      <div className="btn-box">
        <button className="btn" onClick={viewPage}>
          別タブで検索する
        </button>
      </div>
    </div>
