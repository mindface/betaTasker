    ...
    <footer className="index-footer">
      <div className="footer--body _flex_s_b_">
        <div className="footer__box bg-white box--my-evaluation">
          ...
          <div className="improvement-effect p-b-8">情報の改善効果 70%</div>
          <div className="improvement-achievement-rate">組織目的達成率 80%</div>
        </div>
        ...
        <div className="footer__box box--task-info">
          ...
          <div className="improvement-effect p-b-8">Total KPI 32.1%</div>
